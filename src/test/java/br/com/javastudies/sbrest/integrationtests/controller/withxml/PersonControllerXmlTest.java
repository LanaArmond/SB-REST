package br.com.javastudies.sbrest.integrationtests.controller.withxml;
...
class PersonControllerXmlTest extends AbstractIntegrationTest {
    ...
    void hateoasAndHalTest() throws JsonProcessingException {
        ...
        Assertions.assertTrue(Integer.parseInt(totalElements) > 0, "totalElements should be greater than 0");
        Assertions.assertTrue(Integer.parseInt(totalPages) > 0, "totalPages should be greater than 0");
    }
